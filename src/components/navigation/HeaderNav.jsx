  ...
  return (
    <nav className="fz-header-nav">
        <ul className={`align-items-center ${position}`}>
            <li className="fz-nav-item"><Link href="/" className="fz-nav-link">Home</Link></li>
            <li className="fz-nav-item"><Link href="/shop" className="fz-nav-link">Shop</Link></li>
            ...
            {/* <li className="fz-dropdown fz-nav-item">
                ...
                <ul className="fz-submenu">
                    ...
                    <li><Link href="/jewelleryShop" className="fz-nav-link fz-submenu-nav-link">Shop</Link></li>
